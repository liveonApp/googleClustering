...
class _MarkerMapPageState extends State<MarkerMapPage> {
  ...
  final Image image = Image.asset('assets/images/ic_launcher.png');
  // OverlayImage overImage = new OverlayImage('qwe',null);
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      OverlayImage.fromAssetImage(
        assetName: 'assets/images/ic_launcher.png',
        context: context,
      ).then((image) {
        setState(() {
          _markers.add(Marker(
...
// }
  ...
  Future<OverlayImage> makeMarker() {
